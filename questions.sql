...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (5,7,1,'В каком веке родился <strong>Александр</strong> Македонский?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (75,5,'III до н.э.',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (76,5,'II н.э.',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (77,5,'II до н.э.',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (78,5,'XX век',false,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (6,4,2,'Как скомпилировать и запустить java-файл из командной строки?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (80,6,'$ javac Zoo.java <br />$ java Zoo',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (9,2,0,'Какой оператор1?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (65,9,'SELECT FROM',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (66,9,'GOPRKD',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (67,9,'UPDATE SET',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (10,4,2,'Как можно корректно задать строковый параметр метода <em>main()?</em>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (81,10,'String[] args<br />String args[]<br />String... args',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (11,4,1,'Сколько wildcard-звездочек может быть в строке импорта?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (83,11,'Сколько угодно:<br /><strong>import java.nio.*.*;</strong>',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (84,11,'Только одна, в любом месте импорта:<br /><strong>import java.nio.*.Files;</strong>',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (85,11,'Только одна,&nbsp;в конце импорта:<br /><strong>import java.nio.file.*;</strong>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (12,4,2,'Как задать строковые параметры при старте программы из командной строки?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (82,12,'$ javac Zoo.java<br />$ java Zoo Bronx Сat<br />$ java Zoo "San Diego" Gon',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (13,4,2,'Может ли обычный импорт импортировать методы и поля класса?<br /><strong>import java.nio.files.Paths.*;</strong>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (86,13,'Нет.',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (15,3,1,'Minecraft - это очень классная игра?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (7,15,'Да',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (8,15,'Нет',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (9,15,'Конечно',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (16,4,2,'<p>Почему<br /><em><br />import java.util.Date;</em><br /><em>import java.sql.Date;</em><br /><br />не скомпилируется, а <br /><em><br />import java.util.*;<br /></em><em>import java.sql.Date;<br /><br /></em>скомпилируется?<br /><br /></p>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (12,16,'<p>Потому что эксплицитное указание имени класса имеет преимущество над любым wildcard-выражением.</p>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (17,4,2,'<p>Как быть, если в коде одновременно нужно использовать классы с одинаковым именем из разных пакетов?</p>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (14,17,'<p>Использовать полное (fully qualified) имя класса.</p>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (18,4,0,'Classpath можно задать в командной строке:<br /><br />1. Windows<br /><br />java -cp ".;C:\temp\someOtherLocation;c:\temp\myJar.jar" myPackage.MyClass<br /><br />2. Linux<br /><br />java -cp ".:/tmp/someOtherLocation:/tmp/myJar.jar" myPackage.MyClass<br /><br />. (точка) означает, что текущая папка включается в Classpath. <br /><br />Можно использовать wildcard, чтобы включить все jar-файлы в конкретной папке:<br /><br />java -cp "C:\temp\directoryWithJars\*" myPackage.MyClass');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (16,18,'sdf',false,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (19,4,1,'Отметьте фрагменты кода, которые скомпилируются.');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (19,19,'6: public void method(ArrayList list) {<br />7:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (list.isEmpty()) { System.out.println("e");<br />8:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else { System.out.println("n");<br />9:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } }',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (22,19,'1: public class LineNumbers {<br />2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; public void method(ArrayList list) {<br />3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (list.isEmpty()) { System.out.println("e");<br />4:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else { System.out.println("n");<br />5:&nbsp;&nbsp;&nbsp;&nbsp; } } }',false,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (20,4,2,'<p>Может ли имя метода совпадать с именем конструктора (класса).</p>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (57,20,'<p>Да</p>',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (25,6,1,'Что такое Apple?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (32,25,'Это бренд техники.',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (33,25,'Это операционная система.',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (30,25,'Это телефоны.',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (31,25,'Это яблоко.',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (26,6,1,'Как правильно пишется слово ш..колад?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (34,26,'Шакалад',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (35,26,'Шоколад',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (36,26,'Шиколад',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (59,26,'Шуколад',false,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (30,4,2,'Каков порядок выполнения кода в классе?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (40,30,'* Поля и инициализатор экземпляра выполняются в том порядке, в каком они идут в файле.<br />* Конструктор выполняется после всех полей&nbsp;экземпляра и инициализатора экземпляра.',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (31,4,2,'<p>Скомпилируется ли следующий код?<br /><br />class Clazz {<br />&nbsp;{ System.out.println(name); }<br />&nbsp;private String name = "Fluffy";<br />}</p>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (43,31,'<p>Нет. Нельзя ссылаться на переменную, которая еще не инициализирована.</p>',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (33,4,2,'Перечислите примитивные типы данных в Java.');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (50,33,'boolean, byte, short, int, long, float, double, char',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (35,4,2,'Назовите разрядность и диапазон типа <strong>int</strong>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (52,35,'<p>32 бит, [-2 147 483 648, 2 147 483 647]</p>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (36,4,1,'Что будет напечатано после выполнения следующего кода?<br /><br />public class Egg {<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; public Egg() {<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; number = 5;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; public static void main(String[] args) {<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Egg egg = new Egg();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(egg.number);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; private int number = 3;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { number = 4; } <br />}');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (53,36,'<p>3</p>',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (54,36,'<p>4</p>',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (55,36,'<p>5</p>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (37,4,2,'Назовите разрядность и диапазон типа <strong>byte</strong>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (87,37,'8 бит, [-128,&nbsp;127]',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (38,4,2,'Назовите разрядность и диапазон типа <strong>long</strong>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (64,38,'<p>64 бит, [-9 223 372 036 854 775 808, 9 223 372 036 854 775 807]</p>',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (39,4,2,'Назовите разрядность и диапазон типа <strong>short</strong>');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (88,39,'16 бит, [-32 768, 32 767]',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (40,4,2,'Чем конструктор отличается от метода?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (68,40,'1) имя конструктора совпадает с именем класса<br />2) у конструктора нет типа возвращаемого значения',true,NULL);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (41,3,1,'Какой дроп у Крипера?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (71,41,'порох',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (72,41,'Фейерверки',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (73,41,'Динамит(ТНТ)',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (74,41,'Пластинки',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (45,4,2,'Приведите примеры&nbsp;числовых литералов Java с особенностями употребления.');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (89,45,'<strong>int</strong>: 13244.<br />long:',true,NULL);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (51,4,1,'Какие строки из перечисленных скомпилируются?');
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (90,51,'long max = 3123456789;',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (91,51,'long max = 3123456789.5;',false,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (92,51,'long max = 3123456789L;',true,NULL);
	INSERT INTO Answer (id,questionId,text,correct,comment) OVERRIDING SYSTEM VALUE VALUES (93,51,'long max = 3123456789l;',true,NULL);
