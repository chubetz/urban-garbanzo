...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (139,4,0,'В конструкциях while, do-while, for, как и в if, если тело цикла состоит из одного выражения, фигурные скобки можно опустить.');
