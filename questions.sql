...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (735,8,0,'Общий смысл wildcard bounds. В upperBound нельзя запускать методы, принимающие дженерик-тип. В lowerBound запуск методов, возвращающих дженерик-тип, вернет <strong>Object</strong>.<br /><br />class Generic&lt;T&gt; {<br />&nbsp;&nbsp;&nbsp; void transfer(T t) {}<br />&nbsp;&nbsp;&nbsp; T back() {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return null;&nbsp;&nbsp;&nbsp; }<br />}<br />...<br />&nbsp;&nbsp;&nbsp; Generic&lt;Integer&gt; intGen = new Generic&lt;Integer&gt;();<br />&nbsp;&nbsp;&nbsp; Generic&lt;Number&gt; numGen = new Generic&lt;Number&gt;();<br />&nbsp;&nbsp;&nbsp; <br />&nbsp;&nbsp;&nbsp; Generic&lt;? extends Number&gt; numGenUp = intGen;<br />&nbsp;&nbsp;&nbsp; Generic&lt;? super Number&gt; numGenLow = numGen;<br />&nbsp;&nbsp;&nbsp; <br />&nbsp;&nbsp;&nbsp; numGenUp.transfer(4); // doesn''t compile<br />&nbsp;&nbsp;&nbsp; Number num1 = numGenUp.back();<br />&nbsp;&nbsp;&nbsp; numGenLow.transfer(5);<br />&nbsp;&nbsp;&nbsp; Number num2 = numGenLow.back(); //doesn''t compile, т.к. возвр. Object');
