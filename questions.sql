...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (33,4,2,'Перечислите примитивные типы данных в Java.');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (50,33,'boolean, byte, short, int, long, float, double, char',true);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (35,4,2,'Назовите разрядность и диапазон типа <strong>int</strong>');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (52,35,'<p>32 бит, [-2 147 483 648, 2 147 483 647]</p>',true);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (37,4,2,'Назовите разрядность и диапазон типа <strong>byte</strong>');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (87,37,'8 бит, [-128,&nbsp;127]',true);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (38,4,2,'Назовите разрядность и диапазон типа <strong>long</strong>');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (64,38,'<p>64 бит, [-9 223 372 036 854 775 808, 9 223 372 036 854 775 807]</p>',true);
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (39,4,2,'Назовите разрядность и диапазон типа <strong>short</strong>');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (88,39,'16 бит, [-32 768, 32 767]',true);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (45,4,2,'Приведите примеры&nbsp;числовых литералов Java с особенностями употребления.');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (89,45,'<strong>int</strong>: 13244.<br />long:',true);
...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (51,4,1,'Какие строки из перечисленных скомпилируются?');
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (90,51,'long max = 3123456789;',false);
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (91,51,'long max = 3123456789.5;',false);
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (92,51,'long max = 3123456789L;',true);
	INSERT INTO Answer (id,questionId,text,correct) OVERRIDING SYSTEM VALUE VALUES (93,51,'long max = 3123456789l;',true);
