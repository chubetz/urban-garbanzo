...
INSERT INTO Question (id,realmId,type,text) OVERRIDING SYSTEM VALUE VALUES (501,4,0,'На экзамене OCA будут ли уже имеющиеся в Java исключения, либо придуманные специально для вопросов.');
