...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400 id=L_default_10><B>Технические сведения (для персонала службы поддержки)</B> 
      <UL class=adminList>
        <LI id=L_default_11>Код ошибки: 502 Ошибка прокси-сервера. Компонент Forefront TMG отклонил указанный URL-адрес. (12202)
<LI id=L_default_12>IP-адрес: 172.17.0.2
<LI id=L_default_13>Дата: 04.06.2018 14:21:01 [GMT]
<LI id=L_default_14>Сервер: srvgateo.VNIIAS.RU
